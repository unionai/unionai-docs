...
# In this case we use crypto_dogecoin data, which is a public dataset in BigQuery available at https://console.cloud.google.com/bigquery?project=bigquery-public-data&page=table&d=crypto_dogecoin&p=bigquery-public-data&t=transactions
