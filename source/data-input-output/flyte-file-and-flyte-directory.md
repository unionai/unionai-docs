...
* When the `FlyteFile` is passed out of `task_1`, Union uploads the local file to a universally unique generated location in the Union object store (a randomly generated, universally unique location is used to ensure that subsequent uploads of other files never overwrite each other).
