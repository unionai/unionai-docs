...
-   `uctl`{.interpreted-text role="doc"} - uctl is used to interact with
    Union Cloud
-   `uctl_apply_app`{.interpreted-text role="doc"} - Updates apps config
    in configured OAuthProvider
-   `uctl_apply_clusterconfig`{.interpreted-text role="doc"} - Updates
    cluster config
-   `uctl_apply_clusterconfigid`{.interpreted-text role="doc"} - Assign
    cluster config
-   `uctl_apply_clusterpoolconfig`{.interpreted-text role="doc"} -
