...
-   `uctl_apply`{.interpreted-text role="doc"} - Used for updating
    various union/flyte resources including
    tasks/workflows/launchplans/executions/project.
-   `uctl_config`{.interpreted-text role="doc"} - Runs various config
    commands, look at the help of this command to get a list of
    available commands..
-   `uctl_create`{.interpreted-text role="doc"} - Used for creating
    ...
    configs
-   `uctl_delete`{.interpreted-text role="doc"} - Used for
    terminating/deleting various union/flyte resources including
    tasks/workflows/launchplans/executions/project
-   `uctl_demo`{.interpreted-text role="doc"} - Helps with demo
    interactions like start, teardown, status, and exec.
-   `uctl_get`{.interpreted-text role="doc"} - Used for fetching various
    union/flyte resources including
    tasks/workflows/launchplans/executions/project.
-   `uctl_register`{.interpreted-text role="doc"} - Registers tasks,
    workflows, and launch plans from a list of generated serialized
    files.
-   `uctl_update`{.interpreted-text role="doc"} - Used for updating
    various union/flyte resources including apps, cluster pools, cluster
    configs
-   `uctl_version`{.interpreted-text role="doc"} - Fetches uctl version
