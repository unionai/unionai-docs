...
-   `uctl`{.interpreted-text role="doc"} - uctl is used to interact with
    Union Cloud
-   `uctl_delete_app`{.interpreted-text role="doc"} - Delete application
-   `uctl_delete_cluster`{.interpreted-text role="doc"} - Delete
    clusters
-   `uctl_delete_cluster-pool-attributes`{.interpreted-text
    role="doc"} - Deletes matchable resources of cluster pool attribute
-   `uctl_delete_cluster-resource-attribute`{.interpreted-text
    role="doc"} - Deletes matchable resources of cluster attributes.
-   `uctl_delete_clusterconfig`{.interpreted-text role="doc"} - Delete
    cluster config
-   `uctl_delete_clusterpool`{.interpreted-text role="doc"} - Delete
    cluster pool
-   `uctl_delete_clusterpoolassignment`{.interpreted-text role="doc"} -
    Delete cluster pool assignment
-   `uctl_delete_execution`{.interpreted-text role="doc"} -
    Terminates/deletes execution resources.
-   `uctl_delete_execution-cluster-label`{.interpreted-text
    role="doc"} - Deletes matchable resources of execution cluster
    label.
-   `uctl_delete_execution-queue-attribute`{.interpreted-text
    role="doc"} - Deletes matchable resources of execution queue
    attributes.
-   `uctl_delete_identityassignments`{.interpreted-text role="doc"} -
    Removes a role assignment from a user or application
-   `uctl_delete_plugin-override`{.interpreted-text role="doc"} -
    Deletes matchable resources of plugin overrides.
-   `uctl_delete_policy`{.interpreted-text role="doc"} - Delete a policy
-   `uctl_delete_role`{.interpreted-text role="doc"} - Delete a role
-   `uctl_delete_task-resource-attribute`{.interpreted-text
    role="doc"} - Deletes matchable resources of task attributes.
-   `uctl_delete_workflow-execution-config`{.interpreted-text
    role="doc"} - Deletes matchable resources of workflow execution
    config.
