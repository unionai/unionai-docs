---
title: uctl delete identityassignments
---
...
To update a user, specify them by their email and run: :
    ...
    ./bin/uctl delete identityassignments --user.email bob@contoso.com --policy contributor
...
id and run :
    ...
    ./bin/uctl delete identityassignments --application.id "contoso-operator" --policy admin
...
You can list existing policy assignments with: :
    ...
    uctl delete identityassignments [flags]
