...
To load completion, run the following commands in accordance with the
shell you are using:
...
-   
    ...
    :   $ source <(uctl completion bash)

        To load completions for each session:

        -   Linux

            $ uctl completion bash > /etc/bash_completion.d/uctl

        -   macOS

            $ uctl completion bash > /usr/local/etc/bash_completion.d/uctl
...
-   
    ...
    :   If shell completion is not already enabled in your environment,
        ...
        Once enabled, execute once:
            ...
            $ uctl completion zsh > "${fpath[1]}/_uctl"
...
-   fish
    ...
    > $ uctl completion fish | source
    >
    > To load completions for each session, run:
    >
    >     $ uctl completion fish > ~/.config/fish/completions/uctl.fish

-   PowerShell

    > PS> uctl completion powershell | Out-String | Invoke-Expression
    >
    > To load completions for each session, run:
    >
    >     PS> uctl completion powershell > uctl.ps1
    >
    > and source this file from your PowerShell profile.

<!-- -->

    uctl completion [bash|zsh|fish|powershell]
