...
Takes input project which need to be archived or unarchived. Name of the
project to be updated is mandatory field. Example update project to
activate it. :

    uctl update project -p flytesnacks --activateProject
