...
You can either map over a `LaunchPlan` object defined in one of your python modules, or a [reference launch plan](reference-launch-plans) pointing to a previously registered launch plan.
