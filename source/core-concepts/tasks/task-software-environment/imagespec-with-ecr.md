...
You will need to set up your local Docker client to authenticate with ECR. This is needed for `unionai` to be able to push the image built according to the `ImageSpec` to ECR.
