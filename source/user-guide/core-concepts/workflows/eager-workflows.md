...
Where `config.yaml` contains a Union.ai config file and `my_client_secret_group` and `my_client_secret_key` are the secret group and key that you've configured for your Union.ai
instance.
