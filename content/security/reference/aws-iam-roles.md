...
In self-managed deployments, the customer provisions these roles using Union.ai's documentation and templates. In BYOC deployments, [Union.ai provisions them](../architecture/deployment-models#iam-role-provisioning).
...
For BYOC-specific deployment concerns, see [Deployment models and BYOC differences](../architecture/deployment-models).
