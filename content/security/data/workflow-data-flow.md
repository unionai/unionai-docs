...
**Binary outputs, reports, and code bundles** are accessed via presigned URLs. The data flows directly from the customer's object store to the client -- it does not pass through the control plane.
