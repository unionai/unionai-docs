...
> [!NOTE]
> This walkthrough follows a run's *control flow*. For what the inputs and outputs it moves actually are — **literals**, stored inline or offloaded as **raw data** — and where each lives, see [Where your data lives](../core-concepts/where-data-lives).
