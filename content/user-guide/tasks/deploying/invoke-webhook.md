...
On Union, you can deploy apps (see [Apps documentation](../apps/build/_index)) that can run any deployed Flyte tasks. These apps can be REST API services, like FastAPI, that accept HTTP requests and run tasks on behalf of the caller.
