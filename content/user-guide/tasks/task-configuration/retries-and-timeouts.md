...
For workloads on spot/preemptible compute, see also [Behavior on preemption](./interruptible-tasks-and-queues#behavior-on-preemption), which describes how preempted interruptible tasks are rescheduled.
