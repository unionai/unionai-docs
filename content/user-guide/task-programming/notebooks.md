...
In this example we use the [`flyte.remote`](../../api-reference/flyte-sdk/packages/flyte.remote) package to list existing runs, access them, and download their details and logs.
