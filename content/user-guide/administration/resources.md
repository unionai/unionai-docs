...
See [Workflow States]({{< docs_home flyte v1 >}}/architecture/workflow-state-transitions#workflow-states) for the precise definitions of these states.
...
See [Task States]({{< docs_home flyte v1 >}}/architecture/workflow-state-transitions#task-states) for the precise definitions of these states.
