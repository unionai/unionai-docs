...
* **Settings**:
  ...
  * **Raw output data config**: Remote path prefix to store raw output data.
    ...
    See [Raw data store](/user-guide/data-input-output/task-input-and-output/#raw-data-store)
  ...
  * **Force interruptible**: A three valued setting for overriding the interruptible setting of the workflow for this particular execution.
    ...
    See [Interruptible instances](/user-guide/core-concepts/tasks/task-hardware-environment/interruptible-instances/#interruptible-instances)
