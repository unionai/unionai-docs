...
{{< code file="/unionai-examples/v2/integrations/flyte-plugins/openai/openai/agents_tools.py" fragment=uv-script lang=python >}}

Next, we'll import the libraries and create a `TaskEnvironment`, which we need to run the example:

{{< code file="/unionai-examples/v2/integrations/flyte-plugins/openai/openai/agents_tools.py" fragment=imports-task-env lang=python >}}
...
{{< code file="/unionai-examples/v2/integrations/flyte-plugins/openai/openai/agents_tools.py" fragment=tools lang=python >}}
...
{{< code file="/unionai-examples/v2/integrations/flyte-plugins/openai/openai/agents_tools.py" fragment=agent lang=python >}}
...
{{< code file="/unionai-examples/v2/integrations/flyte-plugins/openai/openai/agents_tools.py" fragment=main lang=python >}}
...
The full code is available [on GitHub](https://github.com/unionai/unionai-examples/tree/main/v2/integrations/flyte-plugins/openai/openai).
