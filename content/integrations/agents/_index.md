...
> See [System one datatypes](../../user-guide/system-one-datatypes/_index) for the pattern, and the [TypeSafe AI integration](../typesafe-ai/_index) for the plugin that supplies it.
...
- [System one datatypes](../../user-guide/system-one-datatypes/_index): typed guards, routing and control flow to put in front of the generative loop — and the [TypeSafe AI integration](../typesafe-ai/_index) behind it.
