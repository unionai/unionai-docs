...
> See [System One models](../../user-guide/agents/system_one) for the pattern, and the [TypeSafe AI integration](../typesafe-ai/_index) for the plugin that supplies it.
...
- [System One models](../../user-guide/agents/system_one): typed guards, routing and control flow to put in front of the generative loop — and the [TypeSafe AI integration](../typesafe-ai/_index) behind it.
