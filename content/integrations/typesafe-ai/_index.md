...
For the pattern in full — composing verdicts from atomic questions, confidence-gated routing, and typed agent loops — see [System One models](../../user-guide/agents/system_one) in the user guide.
...
- [System One models](../../user-guide/agents/system_one): the guard, composition and confidence-gating patterns, end to end.
