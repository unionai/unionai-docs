...
For the pattern in full — composing verdicts from atomic questions, confidence-gated routing, and typed agent loops — see [System one types](../../user-guide/system-one-types/_index) in the user guide.
...
- [System one types](../../user-guide/system-one-types/_index): the guard, composition and confidence-gating patterns, end to end.
