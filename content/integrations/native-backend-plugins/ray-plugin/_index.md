...
To enable the plugin in the backend, refer to the instructions provided in the [Configuyre Kubernetes Pluginsep](../../../deployment/flyte/flyte-plugins/kubernetes-plugins) guide.
