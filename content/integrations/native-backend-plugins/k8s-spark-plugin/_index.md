...
The Spark plugin utilizes the same default log configuration outlined in the section on [Configuring logging links in the UI](../../../deployment/flyte-configuration/configuring-logging-links-in-the-ui).
