...
A project in Flyte is a group of [workflows](../../user-guide/core-concepts/workflows/_index) and [tasks](../../user-guide/core-concepts/tasks/_index) tied together to achieve a goal.
