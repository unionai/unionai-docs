...
```
## Tasks
Defines one or more [tasks](../../user-guide/core-concepts/tasks)  that can then be referenced in the spec.

## Subworkflows
Defines zero or more [workflows](../../user-guide/core-concepts/workflows) that can then be referenced in the spec.
