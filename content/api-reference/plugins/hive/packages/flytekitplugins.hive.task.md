...
| [`HiveSelectTask`](.././flytekitplugins.hive.task#flytekitpluginshivetaskhiveselecttask) | This is the simplest form of a Hive Task, that can be used even for tasks that do not produce any output. |
...
## flytekitplugins.hive.task.HiveTask
