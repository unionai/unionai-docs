...
| [`chmod()`](#chmod) | Set Access Control on a bucket/key. |
| [`clear_instance_cache()`](#clear_instance_cache) | Clear the cache of filesystem instances. |
| [`clear_multipart_uploads()`](#clear_multipart_uploads) | Remove any partial uploads in the bucket. |
| [`close_session()`](#close_session) |  |
| [`connect()`](#connect) | Establish S3 connection object. |
...
| [`get_delegated_s3pars()`](#get_delegated_s3pars) | Get temporary credentials from STS, appropriate for sending across a. |
| [`get_file()`](#get_file) | Copy single remote file to local. |
| [`get_mapper()`](#get_mapper) | Create key/value store based on this file-system. |
| [`get_s3()`](#get_s3) |  |
| [`get_tags()`](#get_tags) | Retrieve tag key/values for the given path. |
| [`getxattr()`](#getxattr) | Get an attribute from the metadata. |
...
| [`invalidate_region_cache()`](#invalidate_region_cache) | Invalidate the region cache (associated with buckets). |
| [`is_bucket_versioned()`](#is_bucket_versioned) |  |
| [`isdir()`](#isdir) |  |
...
| [`make_bucket_versioned()`](#make_bucket_versioned) | Set bucket versioning status. |
| [`makedir()`](#makedir) | Alias of `AbstractFileSystem. |
| [`makedirs()`](#makedirs) |  |
| [`merge()`](#merge) | Create single S3 file from list of S3 files. |
| [`metadata()`](#metadata) | Return metadata of path. |
| [`mkdir()`](#mkdir) |  |
| [`mkdirs()`](#mkdirs) | Alias of `AbstractFileSystem. |
| [`modified()`](#modified) | Return the last modified timestamp of file at `path` as a datetime. |
| [`move()`](#move) | Alias of `AbstractFileSystem. |
| [`mv()`](#mv) | Move file(s) from one location to another. |
| [`object_version_info()`](#object_version_info) |  |
...
| [`put_tags()`](#put_tags) | Set tags for given existing key. |
...
| [`rmdir()`](#rmdir) |  |
| [`set_session()`](#set_session) | Establish S3 connection object. |
| [`setxattr()`](#setxattr) | Set metadata. |
...
| [`split_path()`](#split_path) | Normalise S3 path string into bucket and key. |
...
| [`touch()`](#touch) | Create empty file or truncate. |
...
| [`url()`](#url) | Generate presigned URL to access path by HTTP. |
