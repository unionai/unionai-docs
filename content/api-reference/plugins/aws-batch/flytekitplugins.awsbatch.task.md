...
| Class | Description |
|-|-|
| [`AWSBatchConfig`](.././flytekitplugins.awsbatch.task#flytekitpluginsawsbatchtaskawsbatchconfig) | Use this to configure SubmitJobInput for a AWS batch job. |
| [`AWSBatchFunctionTask`](.././flytekitplugins.awsbatch.task#flytekitpluginsawsbatchtaskawsbatchfunctiontask) | Actual Plugin that transforms the local python code for execution within AWS batch job. |

## flytekitplugins.awsbatch.task.AWSBatchConfig
...
class AWSBatchConfig(
    ...
    schedulingPriority: typing.Optional[int],
    platformCapabilities: str,
    propagateTags: typing.Optional[bool],
...
## flytekitplugins.awsbatch.task.AWSBatchFunctionTask
...
class AWSBatchFunctionTask(
    task_config: flytekitplugins.awsbatch.task.AWSBatchConfig,
