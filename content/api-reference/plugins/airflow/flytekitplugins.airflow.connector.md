...
def get_log_links(
    ...
    airflow_trigger: typing.Optional[airflow.triggers.base.BaseTrigger] = None,
...
class AirflowMetadata(
    ...
    airflow_trigger: flytekitplugins.airflow.task.AirflowObj = None,
    airflow_trigger_callback: str = None,
