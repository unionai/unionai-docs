...
metadata:
  ...
  description: This package enables seamless use of model inference sidecar services
    within Flyte
  namespace_packages:
  - flytekitplugins
  packages:
  ...
  - flytekitplugins.inference.vllm
  install_requires:
  - flytekit>=1.13.0,<2.0.0
  - kubernetes
  - openai
  license: apache2
  python_requires: '>=3.9'
  ...
  entry_points:
    flytekit.plugins:
    - inference=flytekitplugins.inference
  folder: flytekit-inference
---
