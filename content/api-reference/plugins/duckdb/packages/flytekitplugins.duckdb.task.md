...
| `query` | `typing.Union[str, typing.List[str], NoneType]` | DuckDB query to execute |
| `inputs` | `typing.Optional[typing.Dict[str, typing.Union[flytekit.types.structured.structured_dataset.StructuredDataset, list]]]` | The query parameters to be used while executing the query |
| `provider` | `typing.Union[flytekitplugins.duckdb.task.DuckDBProvider, typing.Callable]` | DuckDB provider |
| `kwargs` | `**kwargs` | |
