...
| [`MMCloudTask`](.././flytekitplugins.mmcloud.task#flytekitpluginsmmcloudtaskmmcloudtask) | A Python Function task should be used as the base for all extensions that have a python function. |
...
```python
class MMCloudTask(
    task_config: typing.Optional[flytekitplugins.mmcloud.task.MMCloudConfig],
    task_function: collections.abc.Callable,
