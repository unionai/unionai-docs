...
| Class | Description |
|-|-|
| [`flytekitplugins.kfmpi.task.CleanPodPolicy`](../packages/flytekitplugins.kfmpi.task#flytekitpluginskfmpitaskcleanpodpolicy) |CleanPodPolicy describes how to deal with pods when the job is finished. |
...
| [`flytekitplugins.kfmpi.task.RestartPolicy`](../packages/flytekitplugins.kfmpi.task#flytekitpluginskfmpitaskrestartpolicy) |RestartPolicy describes how the replicas should be restarted. |
