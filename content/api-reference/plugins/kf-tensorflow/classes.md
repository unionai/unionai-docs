...
| [`flytekitplugins.kftensorflow.task.CleanPodPolicy`](../packages/flytekitplugins.kftensorflow.task#flytekitpluginskftensorflowtaskcleanpodpolicy) |CleanPodPolicy describes how to deal with pods when the job is finished. |
...
| [`flytekitplugins.kftensorflow.task.RestartPolicy`](../packages/flytekitplugins.kftensorflow.task#flytekitpluginskftensorflowtaskrestartpolicy) |RestartPolicy describes how the replicas should be restarted. |
