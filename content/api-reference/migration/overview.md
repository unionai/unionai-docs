...
For more on the pure Python model, see [Pure Python](../../../user-guide/migration/flyte-2/pure-python).
For more on the async model, see [Asynchronous model](../../../user-guide/migration/flyte-2/async).
