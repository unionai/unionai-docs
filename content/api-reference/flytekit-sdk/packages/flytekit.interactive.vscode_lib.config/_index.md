...
| Class | Description |
|-|-|
| [`VscodeConfig`](../flytekit.interactive.vscode_lib.config/vscodeconfig) | VscodeConfig is the config contains default URLs of the VSCode server and extension remote paths. |
