---
title: flytekit.extras.tensorflow.model
version: 1.16.10
...
| Class | Description |
|-|-|
| [`TensorFlowModelTransformer`](.././flytekit.extras.tensorflow.model#flytekitextrastensorflowmodeltensorflowmodeltransformer) | Base transformer type that should be implemented for every python native type that can be handled by flytekit. |
...
```python
def TensorFlowModelTransformer()
```
### Methods
...
def async_to_literal(
    ...
    python_val: keras.src.models.model.Model,
    python_type: typing.Type[keras.src.models.model.Model],
...
| `python_val` | `keras.src.models.model.Model` | The actual value to be transformed |
| `python_type` | `typing.Type[keras.src.models.model.Model]` | The assumed type of the value (this matches the declared type on the function) |
...
def async_to_python_value(
    ...
    expected_python_type: typing.Type[keras.src.models.model.Model],
...
| `expected_python_type` | `typing.Type[keras.src.models.model.Model]` | Expected native python type that should be returned |
...
def get_literal_type(
    t: typing.Type[keras.src.models.model.Model],
...
) -> typing.Type[keras.src.models.model.Model]
```
