...
| Class | Description |
|-|-|
| [`InstanceTrackingMeta`](../flytekit.core.tracker/instancetrackingmeta) | Please see the original class :flytekit. |
| [`TrackedInstance`](../flytekit.core.tracker/trackedinstance) | Please see the notes for the metaclass above first. |
