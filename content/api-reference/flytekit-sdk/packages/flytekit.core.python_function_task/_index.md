...
| [`EagerFailureHandlerTask`](../flytekit.core.python_function_task/eagerfailurehandlertask) | A Python AutoContainer task should be used as the base for all extensions that want the user's code to be in the. |
| [`EagerFailureTaskResolver`](../flytekit.core.python_function_task/eagerfailuretaskresolver) | Flytekit tasks interact with the Flyte platform very, very broadly in two steps. |
