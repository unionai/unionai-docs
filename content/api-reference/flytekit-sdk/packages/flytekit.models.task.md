...
class DataLoadingConfig(
    ...
    output_path: str,
    enabled: bool,
    format: <google.protobuf.internal.enum_type_wrapper.EnumTypeWrapper object at 0x10531ef90>,
...
```python
class IOStrategy(
    download_mode: <google.protobuf.internal.enum_type_wrapper.EnumTypeWrapper object at 0x105319130>,
    upload_mode: <google.protobuf.internal.enum_type_wrapper.EnumTypeWrapper object at 0x105319220>,
)
```
| Parameter | Type |
|-|-|
