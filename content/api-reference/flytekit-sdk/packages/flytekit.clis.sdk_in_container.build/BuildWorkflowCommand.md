...
**Package:** `flytekit.clis.sdk_in_container.build`
...
| `exe_entity` |  | string of the flyte entity provided by the user. Should be the name of a workflow, or task function. :return: |
