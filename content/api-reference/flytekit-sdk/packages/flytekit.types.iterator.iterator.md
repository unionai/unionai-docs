...
| Class | Description |
|-|-|
| [`FlyteContext`](.././flytekit.types.iterator.iterator#flytekittypesiteratoriteratorflytecontext) | This is an internal-facing context object, that most users will not have to deal with. |
| [`FlyteIterator`](.././flytekit.types.iterator.iterator#flytekittypesiteratoriteratorflyteiterator) | None. |
...
| [`Literal`](.././flytekit.types.iterator.iterator#flytekittypesiteratoriteratorliteral) | None. |
| [`LiteralCollection`](.././flytekit.types.iterator.iterator#flytekittypesiteratoriteratorliteralcollection) | None. |
| [`LiteralType`](.././flytekit.types.iterator.iterator#flytekittypesiteratoriteratorliteraltype) | None. |
| [`TypeEngine`](.././flytekit.types.iterator.iterator#flytekittypesiteratoriteratortypeengine) | Core Extensible TypeEngine of Flytekit. |
| [`TypeTransformer`](.././flytekit.types.iterator.iterator#flytekittypesiteratoriteratortypetransformer) | Base transformer type that should be implemented for every python native type that can be handled by flytekit. |

### Errors

* [`TypeTransformerFailedError`](.././flytekit.types.iterator.iterator#flytekittypesiteratoriteratortypetransformerfailederror)

## flytekit.types.iterator.iterator.FlyteContext
...
## flytekit.types.iterator.iterator.Literal
...
## flytekit.types.iterator.iterator.LiteralCollection
...
## flytekit.types.iterator.iterator.LiteralType
...
## flytekit.types.iterator.iterator.TypeEngine
...
## flytekit.types.iterator.iterator.TypeTransformer
...
## flytekit.types.iterator.iterator.TypeTransformerFailedError
