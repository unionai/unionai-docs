...
| [`ComparisonOps`](../flytekit.core.promise/comparisonops) | Create a collection of name/value pairs. |
...
| [`ConjunctionOps`](../flytekit.core.promise/conjunctionops) | Create a collection of name/value pairs. |
...
|-|-|
| [`HasFlyteInterface`](../flytekit.core.promise/hasflyteinterface) | Base class for protocol classes. |
| [`LocallyExecutable`](../flytekit.core.promise/locallyexecutable) | Base class for protocol classes. |
| [`SupportsNodeCreation`](../flytekit.core.promise/supportsnodecreation) | Base class for protocol classes. |
