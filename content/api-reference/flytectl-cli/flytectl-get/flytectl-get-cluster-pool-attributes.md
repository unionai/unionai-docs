---
title: flytectl get cluster-pool-attributes
...
```shell
$ flytectl get cluster-pool-attributes -d staging
```

To fetch cluster pool project and domain attributes:

```shell
$ flytectl get cluster-pool-attributes -p flytesnacks -d staging
```

To fetch cluster pool workflow attributes:

```shell
$ flytectl get cluster-pool-attributes -p flytesnacks -d staging --workflow my_wf
```
