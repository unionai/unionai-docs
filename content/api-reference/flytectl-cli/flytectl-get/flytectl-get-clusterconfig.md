---
title: flytectl get clusterconfig
...
```shell
$ flytectl get clusterconfig --configID default
```

To fetch cluster config template:

```shell
$ flytectl get clusterconfig --clusterName mycluster123
```

To fetch cluster config template and save to file:

```shell
$ flytectl get clusterconfig --clusterName mycluster123 --outputFile spec.yaml
```

To fetch compiled cluster config:

```shell
$ flytectl get clusterconfig --clusterName mycluster123 --compiled
```
