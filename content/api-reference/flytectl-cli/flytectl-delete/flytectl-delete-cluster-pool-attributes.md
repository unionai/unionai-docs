---
title: flytectl delete cluster-pool-attributes
...
```shell
$ flytectl delete cluster-pool-attributes -p flytesnacks -d staging
```

Delete workflow cluster pool attributes:

```shell
$ flytectl delete cluster-pool-attributes -p flytesnacks -d staging --workflow my_wf
```
