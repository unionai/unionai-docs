...
```shell
$ flytectl delete identityassignments --user.email bob@contoso.com --policy contributor
```
...
```shell
$ flytectl delete identityassignments --application.id "contoso-operator" --policy admin
```
