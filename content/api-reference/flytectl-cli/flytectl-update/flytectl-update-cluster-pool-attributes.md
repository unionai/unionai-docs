...
flytectl update cluster-pool-attribute --attrFile cpa.yaml

To generate a skeleton cpa.yaml:

:

flytectl update cluster-pool-attribute --genSkeleton --attrFile cpa.yaml

```shell
$ flytectl update cluster-pool-attributes [flags]
```
