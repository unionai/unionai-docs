...
| Class | Description |
|-|-|
| [`Blob`](.././flytekit.types.file.image#flytekittypesfileimageblob) |  |
| [`BlobMetadata`](.././flytekit.types.file.image#flytekittypesfileimageblobmetadata) | This is metadata for the Blob literal. |
| [`FlyteContext`](.././flytekit.types.file.image#flytekittypesfileimageflytecontext) | This is an internal-facing context object, that most users will not have to deal with. |
| [`Literal`](.././flytekit.types.file.image#flytekittypesfileimageliteral) |  |
| [`LiteralType`](.././flytekit.types.file.image#flytekittypesfileimageliteraltype) |  |
...
| [`Scalar`](.././flytekit.types.file.image#flytekittypesfileimagescalar) |  |
| [`TypeEngine`](.././flytekit.types.file.image#flytekittypesfileimagetypeengine) | Core Extensible TypeEngine of Flytekit. |
| [`TypeTransformer`](.././flytekit.types.file.image#flytekittypesfileimagetypetransformer) | Base transformer type that should be implemented for every python native type that can be handled by flytekit. |

### Errors

| Exception | Description |
|-|-|
| [`TypeTransformerFailedError`](.././flytekit.types.file.image#flytekittypesfileimagetypetransformerfailederror) | Inappropriate argument type. |
...
## flytekit.types.file.image.Blob
...
## flytekit.types.file.image.BlobMetadata
...
## flytekit.types.file.image.FlyteContext
...
## flytekit.types.file.image.Literal
...
## flytekit.types.file.image.LiteralType
...
## flytekit.types.file.image.Scalar
...
## flytekit.types.file.image.TypeEngine
...
## flytekit.types.file.image.TypeTransformer
...
## flytekit.types.file.image.TypeTransformerFailedError
