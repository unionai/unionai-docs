...
| Class | Description |
|-|-|
| [`AsyncTypeTransformer`](.././flytekit.types.schema.types_pandas#flytekittypesschematypes_pandasasynctypetransformer) | Base transformer type that should be implemented for every python native type that can be handled by flytekit. |
| [`FlyteContext`](.././flytekit.types.schema.types_pandas#flytekittypesschematypes_pandasflytecontext) | This is an internal-facing context object, that most users will not have to deal with. |
| [`Literal`](.././flytekit.types.schema.types_pandas#flytekittypesschematypes_pandasliteral) |  |
| [`LiteralType`](.././flytekit.types.schema.types_pandas#flytekittypesschematypes_pandasliteraltype) |  |
| [`LocalIOSchemaReader`](.././flytekit.types.schema.types_pandas#flytekittypesschematypes_pandaslocalioschemareader) | Base SchemaReader to handle any readers (that can manage their own IO or otherwise). |
| [`LocalIOSchemaWriter`](.././flytekit.types.schema.types_pandas#flytekittypesschematypes_pandaslocalioschemawriter) | Abstract base class for generic types. |
...
| [`Scalar`](.././flytekit.types.schema.types_pandas#flytekittypesschematypes_pandasscalar) |  |
| [`Schema`](.././flytekit.types.schema.types_pandas#flytekittypesschematypes_pandasschema) |  |
| [`SchemaEngine`](.././flytekit.types.schema.types_pandas#flytekittypesschematypes_pandasschemaengine) | This is the core Engine that handles all schema sub-systems. |
| [`SchemaFormat`](.././flytekit.types.schema.types_pandas#flytekittypesschematypes_pandasschemaformat) | Represents the schema storage format (at rest). |
| [`SchemaHandler`](.././flytekit.types.schema.types_pandas#flytekittypesschematypes_pandasschemahandler) |  |
| [`SchemaType`](.././flytekit.types.schema.types_pandas#flytekittypesschematypes_pandasschematype) |  |
| [`TypeEngine`](.././flytekit.types.schema.types_pandas#flytekittypesschematypes_pandastypeengine) | Core Extensible TypeEngine of Flytekit. |
...
## flytekit.types.schema.types_pandas.AsyncTypeTransformer
...
## flytekit.types.schema.types_pandas.FlyteContext
...
## flytekit.types.schema.types_pandas.Literal
...
## flytekit.types.schema.types_pandas.LiteralType
...
## flytekit.types.schema.types_pandas.LocalIOSchemaReader
...
## flytekit.types.schema.types_pandas.LocalIOSchemaWriter
...
## flytekit.types.schema.types_pandas.Scalar
...
## flytekit.types.schema.types_pandas.Schema
...
## flytekit.types.schema.types_pandas.SchemaEngine
...
## flytekit.types.schema.types_pandas.SchemaFormat

Represents the schema storage format (at rest).
Currently only parquet is supported


## flytekit.types.schema.types_pandas.SchemaHandler
...
## flytekit.types.schema.types_pandas.SchemaType
...
## flytekit.types.schema.types_pandas.TypeEngine
