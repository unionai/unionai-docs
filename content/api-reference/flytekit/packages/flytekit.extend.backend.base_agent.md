...
| [`AgentRegistry`](.././flytekit.extend.backend.base_agent#flytekitextendbackendbase_agentagentregistry) | This is the registry for all connectors. |
| [`AsyncAgentBase`](.././flytekit.extend.backend.base_agent#flytekitextendbackendbase_agentasyncagentbase) | This is the base class for all async connectors. |
...
| [`SyncAgentBase`](.././flytekit.extend.backend.base_agent#flytekitextendbackendbase_agentsyncagentbase) | This is the base class for all sync connectors. |
...
| [`TaskCategory`](.././flytekit.extend.backend.base_agent#flytekitextendbackendbase_agenttaskcategory) |  |
