...
| Method | Description |
|-|-|
| [`_get_deck()`](#_get_deck) | Get flyte deck html string. |
| [`_output_deck()`](#_output_deck) |  |
| [`escape()`](#escape) | Replace special characters "&", "<" and ">" to HTML-safe sequences. |
...
def _get_deck(
    ...
    ignore_jupyter: bool,
) -> typing.Union[str, ForwardRef('IPython.core.display.HTML')]
```
