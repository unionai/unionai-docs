...
| Class | Description |
|-|-|
| [`CopyFileDetection`](.././flytekit.clis.sdk_in_container.package#flytekitclissdk_in_containerpackagecopyfiledetection) | Create a collection of name/value pairs. |
| [`FastPackageOptions`](.././flytekit.clis.sdk_in_container.package#flytekitclissdk_in_containerpackagefastpackageoptions) | FastPackageOptions is used to set configuration options when packaging files. |
| [`FastSerializationSettings`](.././flytekit.clis.sdk_in_container.package#flytekitclissdk_in_containerpackagefastserializationsettings) | This object hold information about settings necessary to serialize an object so that it can be fast-registered. |
| [`ImageConfig`](.././flytekit.clis.sdk_in_container.package#flytekitclissdk_in_containerpackageimageconfig) | We recommend you to use ImageConfig. |
| [`SerializationSettings`](.././flytekit.clis.sdk_in_container.package#flytekitclissdk_in_containerpackageserializationsettings) | These settings are provided while serializing a workflow and task, before registration. |

### Errors

| Exception | Description |
|-|-|
| [`NoSerializableEntitiesError`](.././flytekit.clis.sdk_in_container.package#flytekitclissdk_in_containerpackagenoserializableentitieserror) | Common base class for all non-exit exceptions. |
...
## flytekit.clis.sdk_in_container.package.CopyFileDetection
...
## flytekit.clis.sdk_in_container.package.FastPackageOptions
...
## flytekit.clis.sdk_in_container.package.FastSerializationSettings
...
## flytekit.clis.sdk_in_container.package.ImageConfig
...
## flytekit.clis.sdk_in_container.package.NoSerializableEntitiesError

Common base class for all non-exit exceptions.


## flytekit.clis.sdk_in_container.package.SerializationSettings
