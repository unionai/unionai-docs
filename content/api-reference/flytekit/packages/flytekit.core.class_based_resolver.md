...
| [`PythonAutoContainerTask`](.././flytekit.core.class_based_resolver#flytekitcoreclass_based_resolverpythonautocontainertask) | A Python AutoContainer task should be used as the base for all extensions that want the user's code to be in the. |
| [`SerializationSettings`](.././flytekit.core.class_based_resolver#flytekitcoreclass_based_resolverserializationsettings) | These settings are provided while serializing a workflow and task, before registration. |
| [`TaskResolverMixin`](.././flytekit.core.class_based_resolver#flytekitcoreclass_based_resolvertaskresolvermixin) | Flytekit tasks interact with the Flyte platform very, very broadly in two steps. |
| [`TrackedInstance`](.././flytekit.core.class_based_resolver#flytekitcoreclass_based_resolvertrackedinstance) | Please see the notes for the metaclass above first. |
...
## flytekit.core.class_based_resolver.PythonAutoContainerTask
...
## flytekit.core.class_based_resolver.SerializationSettings
...
## flytekit.core.class_based_resolver.TaskResolverMixin
...
## flytekit.core.class_based_resolver.TrackedInstance
