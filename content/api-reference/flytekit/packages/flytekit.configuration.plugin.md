...
| Method | Description |
|-|-|
| [`_get_plugin_from_entrypoint()`](#_get_plugin_from_entrypoint) | Get plugin from entrypoint. |
...
def command(
    args: `*args`,
    kwargs: `**kwargs`,
) -> typing.Union[typing.Callable[[typing.Callable[..., typing.Any]], click.core.Command], click.core.Command]
```
...
def group(
    args: `*args`,
    kwargs: `**kwargs`,
) -> typing.Union[typing.Callable[[typing.Callable[..., typing.Any]], ForwardRef('Group')], ForwardRef('Group')]
```
