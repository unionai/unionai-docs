---
title: flytekit.clis.sdk_in_container.fetch
...
| Class | Description |
|-|-|
| [`FlyteRemote`](.././flytekit.clis.sdk_in_container.fetch#flytekitclissdk_in_containerfetchflyteremote) | Main entrypoint for programmatically accessing a Flyte remote backend. |
| [`Literal`](.././flytekit.clis.sdk_in_container.fetch#flytekitclissdk_in_containerfetchliteral) | None. |
| [`LiteralsResolver`](.././flytekit.clis.sdk_in_container.fetch#flytekitclissdk_in_containerfetchliteralsresolver) | LiteralsResolver is a helper class meant primarily for use with the FlyteRemote experience or any other situation. |
| [`Panel`](.././flytekit.clis.sdk_in_container.fetch#flytekitclissdk_in_containerfetchpanel) | A console renderable that draws a border around its contents. |
| [`Pretty`](.././flytekit.clis.sdk_in_container.fetch#flytekitclissdk_in_containerfetchpretty) | A rich renderable that pretty prints an object. |

## flytekit.clis.sdk_in_container.fetch.FlyteRemote
...
## flytekit.clis.sdk_in_container.fetch.Literal
...
## flytekit.clis.sdk_in_container.fetch.LiteralsResolver
...
## flytekit.clis.sdk_in_container.fetch.Panel
...
## flytekit.clis.sdk_in_container.fetch.Pretty
