...
| Class | Description |
|-|-|
| [`NumpyArrayTransformer`](.././flytekit.types.numpy#flytekittypesnumpynumpyarraytransformer) | TypeTransformer that supports np. |
...
## flytekit.types.numpy.NumpyArrayTransformer
