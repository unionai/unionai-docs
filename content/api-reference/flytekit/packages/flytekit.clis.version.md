...
| Class | Description |
|-|-|
| [`FlyteRemote`](.././flytekit.clis.version#flytekitclisversionflyteremote) | Main entrypoint for programmatically accessing a Flyte remote backend. |
| [`Panel`](.././flytekit.clis.version#flytekitclisversionpanel) | A console renderable that draws a border around its contents. |

## flytekit.clis.version.FlyteRemote
