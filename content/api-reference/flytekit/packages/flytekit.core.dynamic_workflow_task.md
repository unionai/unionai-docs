---
title: flytekit.core.dynamic_workflow_task
...
| Class | Description |
|-|-|
| [`PythonFunctionTask`](.././flytekit.core.dynamic_workflow_task#flytekitcoredynamic_workflow_taskpythonfunctiontask) | A Python Function task should be used as the base for all extensions that have a python function. |
