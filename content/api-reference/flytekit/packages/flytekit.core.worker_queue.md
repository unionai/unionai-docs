...
| [`Labels`](.././flytekit.core.worker_queue#flytekitcoreworker_queuelabels) |  |
...
| [`ReferenceEntity`](.././flytekit.core.worker_queue#flytekitcoreworker_queuereferenceentity) |  |
...
| [`WorkflowBase`](.././flytekit.core.worker_queue#flytekitcoreworker_queueworkflowbase) |  |
...
|-|-|
| [`FlyteSystemException`](.././flytekit.core.worker_queue#flytekitcoreworker_queueflytesystemexception) | Common base class for all non-exit exceptions. |
...
| `handling_signal` | `int` |  |
| `logger` | `Logger` |  |
| `standard_output_format` | `Pattern` |  |
