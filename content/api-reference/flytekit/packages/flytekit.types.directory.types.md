...
| [`Binary`](.././flytekit.types.directory.types#flytekittypesdirectorytypesbinary) | None. |
| [`Blob`](.././flytekit.types.directory.types#flytekittypesdirectorytypesblob) | None. |
...
| [`FlyteDirectory`](.././flytekit.types.directory.types#flytekittypesdirectorytypesflytedirectory) | None. |
| [`FlyteFile`](.././flytekit.types.directory.types#flytekittypesdirectorytypesflytefile) | None. |
| [`Literal`](.././flytekit.types.directory.types#flytekittypesdirectorytypesliteral) | None. |
| [`LiteralType`](.././flytekit.types.directory.types#flytekittypesdirectorytypesliteraltype) | None. |
| [`Path`](.././flytekit.types.directory.types#flytekittypesdirectorytypespath) | PurePath subclass that can make system calls. |
| [`Scalar`](.././flytekit.types.directory.types#flytekittypesdirectorytypesscalar) | None. |
| [`SerializableType`](.././flytekit.types.directory.types#flytekittypesdirectorytypesserializabletype) | None. |
...
| [`partial`](.././flytekit.types.directory.types#flytekittypesdirectorytypespartial) | partial(func, *args, **keywords) - new function with partial application. |

### Errors

* [`FlyteAssertion`](.././flytekit.types.directory.types#flytekittypesdirectorytypesflyteassertion)
* [`TypeTransformerFailedError`](.././flytekit.types.directory.types#flytekittypesdirectorytypestypetransformerfailederror)
