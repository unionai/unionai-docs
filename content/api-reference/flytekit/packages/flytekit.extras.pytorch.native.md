...
| Class | Description |
|-|-|
| [`Blob`](.././flytekit.extras.pytorch.native#flytekitextraspytorchnativeblob) |  |
| [`BlobMetadata`](.././flytekit.extras.pytorch.native#flytekitextraspytorchnativeblobmetadata) | This is metadata for the Blob literal. |
| [`FlyteContext`](.././flytekit.extras.pytorch.native#flytekitextraspytorchnativeflytecontext) | This is an internal-facing context object, that most users will not have to deal with. |
| [`Literal`](.././flytekit.extras.pytorch.native#flytekitextraspytorchnativeliteral) |  |
| [`LiteralType`](.././flytekit.extras.pytorch.native#flytekitextraspytorchnativeliteraltype) |  |
...
| [`Scalar`](.././flytekit.extras.pytorch.native#flytekitextraspytorchnativescalar) |  |
| [`TypeEngine`](.././flytekit.extras.pytorch.native#flytekitextraspytorchnativetypeengine) | Core Extensible TypeEngine of Flytekit. |
| [`TypeTransformer`](.././flytekit.extras.pytorch.native#flytekitextraspytorchnativetypetransformer) | Base transformer type that should be implemented for every python native type that can be handled by flytekit. |
| [`TypeVar`](.././flytekit.extras.pytorch.native#flytekitextraspytorchnativetypevar) | Type variable. |

### Errors

| Exception | Description |
|-|-|
| [`TypeTransformerFailedError`](.././flytekit.extras.pytorch.native#flytekitextraspytorchnativetypetransformerfailederror) | Inappropriate argument type. |
...
## flytekit.extras.pytorch.native.Blob
...
## flytekit.extras.pytorch.native.BlobMetadata
...
## flytekit.extras.pytorch.native.FlyteContext
...
## flytekit.extras.pytorch.native.Literal
...
## flytekit.extras.pytorch.native.LiteralType
...
## flytekit.extras.pytorch.native.Scalar
...
## flytekit.extras.pytorch.native.TypeEngine
...
## flytekit.extras.pytorch.native.TypeTransformer
...
## flytekit.extras.pytorch.native.TypeTransformerFailedError

Inappropriate argument type.


## flytekit.extras.pytorch.native.TypeVar
