...
| [`StructuredDatasetMetadata`](.././flytekit.types.structured.basic_dfs#flytekittypesstructuredbasic_dfsstructureddatasetmetadata) |  |
| [`StructuredDatasetType`](.././flytekit.types.structured.basic_dfs#flytekittypesstructuredbasic_dfsstructureddatasettype) |  |
...
|-|-|
| [`NoCredentialsError`](.././flytekit.types.structured.basic_dfs#flytekittypesstructuredbasic_dfsnocredentialserror) | No credentials could be found. |
...
| [`split_protocol()`](#split_protocol) | Return protocol, path pair. |
| [`strip_protocol()`](#strip_protocol) | Return only path part of full URL, according to appropriate backend. |
