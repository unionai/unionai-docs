...
| Class | Description |
|-|-|
| [`Any`](.././flytekit.extras.webhook.task#flytekitextraswebhooktaskany) | Special type indicating an unconstrained type. |
| [`Documentation`](.././flytekit.extras.webhook.task#flytekitextraswebhooktaskdocumentation) | DescriptionEntity contains detailed description for the task/workflow/launch plan. |
| [`Interface`](.././flytekit.extras.webhook.task#flytekitextraswebhooktaskinterface) | A Python native interface object, like inspect. |
| [`PythonTask`](.././flytekit.extras.webhook.task#flytekitextraswebhooktaskpythontask) | Base Class for all Tasks with a Python native ``Interface``. |
| [`SerializationSettings`](.././flytekit.extras.webhook.task#flytekitextraswebhooktaskserializationsettings) | These settings are provided while serializing a workflow and task, before registration. |
| [`SyncConnectorExecutorMixin`](.././flytekit.extras.webhook.task#flytekitextraswebhooktasksyncconnectorexecutormixin) | This mixin class is used to run the sync task locally, and it's only used for local execution. |
...
| [`timedelta`](.././flytekit.extras.webhook.task#flytekitextraswebhooktasktimedelta) | Difference between two datetime values. |
...
## flytekit.extras.webhook.task.Any
...
## flytekit.extras.webhook.task.Documentation
...
## flytekit.extras.webhook.task.Interface
...
## flytekit.extras.webhook.task.PythonTask
...
## flytekit.extras.webhook.task.SerializationSettings
...
## flytekit.extras.webhook.task.SyncConnectorExecutorMixin
...
## flytekit.extras.webhook.task.timedelta
