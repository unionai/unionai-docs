...
| Package | Description |
|-|-|
| [`flytekit`](flytekit) | Core Flytekit. |
...
| [`flytekit.clis.flyte_cli.main`](flytekit.clis.flyte_cli.main) |  |
...
| [`flytekit.clis.sdk_in_container.fetch`](flytekit.clis.sdk_in_container.fetch) |  |
| [`flytekit.clis.sdk_in_container.get`](flytekit.clis.sdk_in_container.get) |  |
| [`flytekit.clis.sdk_in_container.helpers`](flytekit.clis.sdk_in_container.helpers) |  |
| [`flytekit.clis.sdk_in_container.init`](flytekit.clis.sdk_in_container.init) |  |
| [`flytekit.clis.sdk_in_container.launchplan`](flytekit.clis.sdk_in_container.launchplan) |  |
| [`flytekit.clis.sdk_in_container.local_cache`](flytekit.clis.sdk_in_container.local_cache) |  |
...
| [`flytekit.core.dynamic_workflow_task`](flytekit.core.dynamic_workflow_task) | Dynamic Workflows. |
...
| [`flytekit.core.sentinel`](flytekit.core.sentinel) |  |
...
| [`flytekit.extend.backend.base_agent`](flytekit.extend.backend.base_agent) |  |
...
| [`flytekit.types.directory`](flytekit.types.directory) | Flytekit Directory Type. |
| [`flytekit.types.directory.types`](flytekit.types.directory.types) |  |
| [`flytekit.types.error`](flytekit.types.error) | Flytekit Error Type. |
...
| [`flytekit.types.iterator`](flytekit.types.iterator) | Flytekit Iterator Type. |
...
| [`flytekit.types.pickle`](flytekit.types.pickle) | Flytekit Pickle Type. |
...
| [`flytekit.types.structured`](flytekit.types.structured) | Flytekit StructuredDataset. |
