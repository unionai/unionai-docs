...
| Method | Description |
|-|-|
| [`_internal_demo_remote()`](#_internal_demo_remote) | Derives a FlyteRemote object from a sandbox yaml configuration, modifying parts to make it work internally. |
| [`_internal_remote()`](#_internal_remote) | Derives a FlyteRemote object from a yaml configuration file, modifying parts to make it work internally. |
| [`_prepare_remote()`](#_prepare_remote) | Prepare FlyteRemote object for accessing Flyte cluster in a task running on the same cluster. |
...
#### _internal_demo_remote()

```python
def _internal_demo_remote(
...
def _internal_remote(
    remote: flytekit.remote.remote.FlyteRemote,
    client_secret_group: typing.Optional[str],
    client_secret_key: typing.Optional[str],
    client_secret_env_var: typing.Optional[str],
) -> flytekit.remote.remote.FlyteRemote
```
...
```python
def _prepare_remote(
    remote: typing.Optional[flytekit.remote.remote.FlyteRemote],
    ctx: flytekit.core.context_manager.FlyteContext,
    client_secret_group: typing.Optional[str],
    client_secret_key: typing.Optional[str],
    local_entrypoint: bool,
    client_secret_env_var: typing.Optional[str],
