...
| `raw_data_path` | `str \| None` | Object store path to store the model. If not provided, the model is stored using the default path generated by the Flyte storage layer. |
