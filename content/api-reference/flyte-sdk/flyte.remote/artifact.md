...
|-|-|-|
| `cls` |  | |
| `value` | `Any` | The File, Dir, or DataFrame to publish. May be wrapped with `flyte.artifacts.new(...)`; wrapper metadata seeds name/version/ description/data/card, and explicit keyword arguments override it. |
...
| `data` | `Mapping[str, str] \| None` | Optional free-form key/value metadata. |
...
**Returns:** An async iterator of artifacts.
