...
**Package:** `flyteplugins.connectors.snowflake.task`
...
class Snowflake(
    name: str,
    query_template: str,
    plugin_config: flyteplugins.connectors.snowflake.task.SnowflakeConfig,
...
| `plugin_config` | `flyteplugins.connectors.snowflake.task.SnowflakeConfig` | SnowflakeConfig object (includes connection_kwargs for additional parameters) |
