...
class TorchFunctionTask(
    ...
    func: F,
    plugin_config: flyteplugins.pytorch.task.Elastic,
)
```
...
| [`custom_config()`](#custom_config) | Converts the ElasticConfig to a DistributedPyTorchTrainingTask. |
