...
| Method | Description |
|-|-|
| [`connect()`](#connect) | Creates a live connection to the LLM. |
| [`generate_content_async()`](#generate_content_async) | Generates content for a single model turn. |
| [`supported_models()`](#supported_models) | Returns a list of supported models in regex for LlmRegistry. |
...
| Parameter | Type | Description |
|-|-|-|
| `llm_request` | `LlmRequest` | LlmRequest, the request to send to the LLM. |
