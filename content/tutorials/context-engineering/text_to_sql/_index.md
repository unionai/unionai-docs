...
> [!NOTE]
> Code available [on GitHub](https://github.com/unionai/unionai-examples/tree/main/v2/tutorials/text_to_sql); based on work by [LlamaIndex](https://docs.llamaindex.ai/en/stable/examples/workflow/advanced_text_to_sql/).
...
{{< code file="/unionai-examples/v2/tutorials/text_to_sql/data_ingestion.py" fragment=data_ingestion lang=python >}}
...
{{< code file="/unionai-examples/v2/tutorials/text_to_sql/text_to_sql.py" fragment=text_to_sql lang=python >}}
...
{{< code file="/unionai-examples/v2/tutorials/text_to_sql/text_to_sql.py" fragment=index_tables lang=python >}}
...
{{< code file="/unionai-examples/v2/tutorials/text_to_sql/text_to_sql.py" fragment=sql_and_response lang=python >}}
...
{{< code file="/unionai-examples/v2/tutorials/text_to_sql/create_qa_dataset.py" fragment=build_eval_dataset lang=python >}}
...
{{< code file="/unionai-examples/v2/tutorials/text_to_sql/create_qa_dataset.py" fragment=get_and_split_schema lang=python >}}
...
{{< code file="/unionai-examples/v2/tutorials/text_to_sql/create_qa_dataset.py" fragment=generate_questions_and_sql lang=python >}}
...
{{< code file="/unionai-examples/v2/tutorials/text_to_sql/create_qa_dataset.py" fragment=validate_sql lang=python >}}
...
{{< code file="/unionai-examples/v2/tutorials/text_to_sql/optimizer.py" fragment=auto_prompt_engineering lang=python >}}
...
{{< code file="/unionai-examples/v2/tutorials/text_to_sql/optimizer.py" fragment=evaluate_prompt lang=python >}}
...
{{< code file="/unionai-examples/v2/tutorials/text_to_sql/optimizer.py" fragment=prompt_optimizer lang=python >}}
