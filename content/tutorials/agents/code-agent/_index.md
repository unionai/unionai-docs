...
> [!NOTE]
> Code available [on GitHub](https://github.com/unionai/unionai-examples/tree/main/v2/tutorials/code_runner).
...
{{< code file="/unionai-examples/v2/tutorials/code_runner/agent.py" fragment=env lang=python >}}
...
{{< code file="/unionai-examples/v2/tutorials/code_runner/agent.py" fragment=code_base_model lang=python >}}
...
{{< code file="/unionai-examples/v2/tutorials/code_runner/agent.py" fragment=agent_state lang=python >}}
...
{{< code file="/unionai-examples/v2/tutorials/code_runner/agent.py" fragment=docs_retriever lang=python >}}
...
{{< code file="/unionai-examples/v2/tutorials/code_runner/agent.py" fragment=generate lang=python >}}
...
{{< code file="/unionai-examples/v2/tutorials/code_runner/agent.py" fragment=code_runner_task lang=python >}}
...
{{< code file="/unionai-examples/v2/tutorials/code_runner/agent.py" fragment=code_check lang=python >}}
...
{{< code file="/unionai-examples/v2/tutorials/code_runner/agent.py" fragment=reflect lang=python >}}
...
{{< code file="/unionai-examples/v2/tutorials/code_runner/agent.py" fragment=main lang=python >}}
