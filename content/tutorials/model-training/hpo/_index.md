...
> [!NOTE]
> Code available [on GitHub](https://github.com/unionai/unionai-examples/tree/main/v2/tutorials/ml/optimizer.py).
...
{{< code file="/unionai-examples/v2/tutorials/ml/optimizer.py" fragment="imports-1" lang="python" >}}
...
{{< code file="/unionai-examples/v2/tutorials/ml/optimizer.py" fragment="imports-2" lang="python" >}}
...
{{< code file="/unionai-examples/v2/tutorials/ml/optimizer.py" fragment="imports-3" lang="python" >}}
...
{{< code file="/unionai-examples/v2/tutorials/ml/optimizer.py" fragment="optimizer-init" lang="python" >}}
...
{{< code file="/unionai-examples/v2/tutorials/ml/optimizer.py" fragment="optimizer-log" lang="python" >}}
...
{{< code file="/unionai-examples/v2/tutorials/ml/optimizer.py" fragment="optimizer-spawn" lang="python" >}}
...
{{< code file="/unionai-examples/v2/tutorials/ml/optimizer.py" fragment="optimizer-call" lang="python" >}}
...
{{< code file="/unionai-examples/v2/tutorials/ml/optimizer.py" fragment="optimizer-len" lang="python" >}}
...
{{< code file="/unionai-examples/v2/tutorials/ml/optimizer.py" fragment="objective" lang="python" >}}
...
{{< code file="/unionai-examples/v2/tutorials/ml/optimizer.py" fragment="optimize" lang="python" >}}
...
{{< code file="/unionai-examples/v2/tutorials/ml/optimizer.py" fragment="main" lang="python" >}}
