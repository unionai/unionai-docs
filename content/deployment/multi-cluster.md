...
When [configuring your compute plane](./configuring-your-data-plane), you can map each domain or project to its own GCP project or AWS subaccount. You can even mix cloud providers: Some of your domains and/or projects can be mapped to AWS subaccounts while others can be mapped to GCP projects.
...
You specify the cluster pool to which a cluster belongs when you [configure your compute plane](./configuring-your-data-plane) with the help of the {{< key product_name >}} team.
