...
BYOC and Self-managed differ only in _who manages the data plane_: With BYOC, Union manages your data plane (in your account) for you. With Self-managed you manage the data plane entirely yourself.
