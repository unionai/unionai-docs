...
For more information on configuring tasks to use interruptible instances, see [Task configuration](../user-guide/task-configuration#interruptible).
...
Once {{< key product_name >}} has configured and deployed your cluster(s), you will be able to see your data plane setup in **Usage > Compute** in the UI.
