...
> If you are installing at a cloud provider, use the cloud provider specific instructions: [AWS](byok-data-plane-setup-on-AWS), [Azure](./byok-data-plane-setup-on-Azure.md), [OCI](byok-data-plane-setup-on-OCI.md).
