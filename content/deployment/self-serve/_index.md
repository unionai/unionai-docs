...
This is the fastest way to deploy Union.ai, and it starts with a 30-day free trial. You subscribe to **Union.ai Teams** on AWS Marketplace, create your organization in the Union.ai UI, try out a local workflow and follow in the Union.ai UI. When you are ready, create the AWS resources the data plane runs on, and connect your cluster. The data plane will be installed on your cluster for you. You don't have to wait on Union.ai to set it up for you.
...
1. **[Start from AWS Marketplace](./aws-marketplace).** Subscribe to the [Union.ai Teams listing](https://aws.amazon.com/marketplace/pp/prodview-66k3cmidsgv5o) on AWS Marketplace, so the charges appear on your AWS bill, then follow the handoff to Union.ai.
2. **[Sign up and create your Union.ai organization](./sign-up).** Your organization is your team's workspace: it groups your team members, projects, tasks, apps and so on.
