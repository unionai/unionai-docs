...
4. **[Provision your AWS resources](./aws-infrastructure).** Create the EKS cluster, S3 buckets, ECR repository and IAM roles your data plane runs on, in your AWS account.
