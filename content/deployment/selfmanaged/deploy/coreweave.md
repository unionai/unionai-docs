...
# Deploy the data plane on CoreWeave

If you have not yet set up the required CoreWeave resources (CKS cluster, AI Object Storage bucket, access keys, access policy), see [Prepare infrastructure](../infrastructure-recommendations/coreweave) first.
