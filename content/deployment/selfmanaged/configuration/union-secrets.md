...
[Union Secrets](../../../user-guide/tasks/task-configuration/secrets) are enabled by default. Union Secrets are managed secrets created through the native Kubernetes secret manager.
