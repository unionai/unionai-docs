...
Union Image Builder supports the ability to build container images within the dataplane. This enables the use of the `remote` builder type for any defined [Container Image](../../user-guide/tasks/configuring/container-images).
...
Write custom [container images](../../user-guide/tasks/configuring/container-images):
```python
