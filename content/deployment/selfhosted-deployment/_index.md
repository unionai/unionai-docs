...
> [!NOTE]
> Self-hosted deployment is distinct from [self-managed deployment](../_index), where {{< key product_name >}} hosts the control plane and you manage only the data plane.
...
Choose [self-managed deployment](../_index) when:
