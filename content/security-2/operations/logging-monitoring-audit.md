...
Metrics data never leaves the customer's infrastructure. In BYOC deployments, Union.ai [deploys and manages the monitoring stack](../architecture/deployment-models#infrastructure-management).
