...
- **[Contributing docs and examples](https://www.union.ai/docs/v2/flyte/community/contributing-docs)** — authoring guide, shortcodes, variants, API docs (source at `content/community/contributing-docs/`).
